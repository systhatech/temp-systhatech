		  ...
		  <header class="header-dark ree-header fixed-top">
			<div class="container-fluid m-p-l-r-0">
			  <div class="menu-header horzontl">
			   <div class="menu-logo">
				  <div class="dskt-logo"><a class="nav-brand" href="index.html">
				   <img src="systhatech/images/logo.png" alt="Logo" class="ree-logo l-dark" />
				   <img src="systhatech/images/white-logo.png" alt="Logo" class="ree-logo l-white" />
				 </a> </div>
				</div>
							...
							<div class="menu-extra-info-inner">
							  <ul>
								<li>
								  ...
								  <a href="https://separateweb.com/cdn-cgi/l/email-protection#7b091e1e0d1a153b1a19181f55181416"><span class="__cf_email__" data-cfemail="ef9d8a8a998e81af8e8d8c8bc18c8082">[email&#160;protected]</span></a>
								</li>
								<li>
								  <div class="menu-icon-ree">
							...
							<div class="menu-extra-info-inner">
							  <ul>
								<li>
								  ...
								  <a href="https://separateweb.com/cdn-cgi/l/email-protection#9ae8ffffecfbf4dafbf8f9feb4f9f5f7"><span class="__cf_email__" data-cfemail="6d1f08081b0c032d0c0f0e09430e0200">[email&#160;protected]</span></a>
								</li>
								<li>
								  <div class="menu-icon-ree">
									<div class="webiocon"> <i class="fas fa-phone-alt"></i> </div>
				...
				<!-- mobile Nav -->
                @include('systhatech::layout.mobile_nav_white')
			  </div>
			</div>
		  </header>
		  <!-- Header End -->
