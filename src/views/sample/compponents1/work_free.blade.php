		   ...
		   <div class="row mt20 dark-bg">
			  <div class="col-lg-4 col-sm-4 mt40 img-hover">
				 <div class="work-thumbnail">
					<a href="#"> <img src="systhatech/images/portfolio/creative-work-1.jpg" alt="portfolio reevan" class="img-fluid"> </a>
				 </div>
			  ...
			  <div class="col-lg-4 col-sm-4 mt40 img-hover">
				 <div class="work-thumbnail">
					<a href="#"> <img src="systhatech/images/portfolio/creative-work-2.jpg" alt="portfolio reevan" class="img-fluid"> </a>
				 </div>
				 <div class="port-title mt20">
					<h4 class="mb5"><a href="#">Creative business card</a></h4>
					<p>UX, UI, Graphic Design</p>
			  ...
			  <div class="col-lg-4 col-sm-4 mt40 img-hover">
				 <div class="work-thumbnail">
					<a href="#"> <img src="systhatech/images/portfolio/creative-work-3.jpg" alt="portfolio reevan" class="img-fluid"> </a>
				 </div>
				 <div class="port-title mt20">
					<h4 class="mb5"><a href="#">Creative business card</a></h4>
					<p>UX, UI, Graphic Design</p>
			  ...
			  <div class="col-lg-8 col-sm-8 mt40 img-hover">
				 <div class="work-thumbnail">
					<a href="#"> <img src="systhatech/images/portfolio/creative-work-4.jpg" alt="portfolio reevan" class="img-fluid"> </a>
				 </div>
				 <div class="port-title mt20">
					<h4 class="mb5"><a href="#">Creative business card</a></h4>
					<p>UX, UI, Graphic Design</p>
			  ...
			  <div class="col-lg-4 col-sm-4  mt40 img-hover">
				 <div class="work-thumbnail">
					<a href="#"> <img src="systhatech/images/portfolio/creative-work-5.jpg" alt="portfolio reevan" class="img-fluid"> </a>
				 </div>
				 <div class="port-title mt20">
					<h4 class="mb5"><a href="#">Creative business card</a></h4>
					<p>UX, UI, Graphic Design</p>
